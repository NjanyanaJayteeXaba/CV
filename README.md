# CV — Njanyana Laurence Xaba (Jaytee Xaba)

<p align="center">
  <img src="https://github.com/NjanyanaJayteeXaba/NjanyanaJayteeXaba/blob/main/5223113-hd_3840_2160_30fps-ezgif.com-video-to-gif-converter.gif" width="400" height="300" alt="Tech animation" /> 
</p>

## Overview
This repository contains my **CV** and a **mock interview video** presented as a clean, professional web page (GitHub Pages).  
It’s designed to be simple to navigate, mobile-friendly, and easy for recruiters to review.

## Live Site
View the CV here (GitHub Pages):

- **Live CV:** **https://njanyanajayteexaba.github.io/CV/**

> If the link doesn’t load yet, GitHub Pages might still be building (or not enabled). See **Deploy (GitHub Pages)** below.
